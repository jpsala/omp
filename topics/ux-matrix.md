...
| Quota/usage en status | **native** | OMP 18.1.6 registra el segmento `usage`, muestra ventanas y resets del provider, y expone `omp usage`. | Usar el segmento `usage` o `omp usage`; no consultar auth ni crear un poller propio. |

...
const requiredFiles = [
	...
	"extensions/codex-consumption.ts",
	"extensions/live-markdown.ts",
	"extensions/live-markdown-core.ts",
	...
	"tests/work-mode-consumption.test.ts",
	"tests/tool-activity-view.test.ts",
	"tests/live-markdown.test.ts",
